...
object CadRecord4 {
  ...
  private case class CadRecord4Impl[F[_]: Applicative](
  ...
  ) extends CadRecord.CadRecordImpl[F] with CadRecord4[F]

  def build[F[_]: Applicative](server: EpicsServer[F], cadName: String): Resource[F, CadRecord4[F]] = for {
