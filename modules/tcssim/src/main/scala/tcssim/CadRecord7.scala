...
object CadRecord7 {
  ...
  private case class CadRecord7Impl[F[_]: Applicative](
  ...
  ) extends CadRecord.CadRecordImpl[F] with CadRecord7[F]

  def build[F[_]: Applicative](server: EpicsServer[F], cadName: String): Resource[F, CadRecord7[F]] = for {
